...
# Full Dataset
The full `transactions.csv` dataset is too large to include in this repository. You can download it [here]([https://link-to-your-file](https://www.kaggle.com/datasets/mlg-ulb/creditcardfraud)).
